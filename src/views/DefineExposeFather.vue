<template>
  <div class="container pt-3 px-0">
    <section class="p-3 pb-0">
      ...
      <p class="my-2" :data-theme="themeStore.theme">
        先用 <code>ref()</code>
    ...
    <section class="p-3 pb-0">
      <h3 :data-theme="themeStore.theme">1. 用變數去接子層的暴露的變數， 並不會響應式更新</h3>
      <p class="mb-2" :data-theme="themeStore.theme">
    ...
    <section class="p-3 pb-0">
      <h3 :data-theme="themeStore.theme">2. 透過 <code>ref()</code> 讀取子元件的變數，才會響應式更新</h3>
      <p class="mb-2" :data-theme="themeStore.theme">
