<template>
  <div class="container my-3 px-0 py-3">
    ...
    <section class="mb-3 p-3">
      <h2 class="text-20 mb-1" :data-theme="themeStore.theme">1. watchEffect 的任何 "ref" 依賴改變, 都會觸發執行</h2>
      <div class="container">
        <div class="row row-cols-3">
          <div class="col">
            <label for="t1" class="form-label" :data-theme="themeStore.theme">
              t1
              <input type="text" class="form-control" id="t1" v-model="t1" placeholder="輸入文字">
            </label>
          </div>
          <div class="col">
            <label for="t2" class="form-label" :data-theme="themeStore.theme">
              t2
              <input type="text" class="form-control" id="t2" v-model="t2" placeholder="輸入文字">
            </label>
          </div>
          <div class="col">
            <label for="t3" class="form-label" :data-theme="themeStore.theme">
              t3
        ...
        <div>
          <label for="t4" class="form-label" :data-theme="themeStore.theme">
...
watchEffect(() => {
  ...
  watchEddect1.value = `${t1.value}${t2.value}${t3.value}${t4}`
    ...
    <!-- 移除 WatchEffect 監聽 -->
    <section class="mb-3 p-3">
      <h2 class="text-20 mb-1" :data-theme="themeStore.theme">2. 移除 watchEffect 監聽</h2>
      <p class="my-1" :data-theme="themeStore.theme">
